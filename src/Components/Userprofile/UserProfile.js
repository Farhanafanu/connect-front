...
export default function UserProfile() {
  ...
  <div className="bio">
    ...
    {userData && userData.user_profile && userData.user_profile.bio ? (
     <h5>{ userData.user_profile.bio}</h5>
    ) : (
      <input type="text" className="form-control" placeholder="Update bio" />
          ...
          <div className="profile-button">
            <Link to="/chat/id" className="btn" style={{ backgroundColor: '#8A2BE2', color: '#FFFFFF' }}>
              <FontAwesomeIcon icon={faMessage} /> Message
            </Link>
           
            <button className="btn" style={{ backgroundColor: '#8A2BE2', color: '#FFFFFF' }} onClick={openModal}>
                ...
                <div className="modal-content">
                  ...
                  <div className="modal-body">
                    <form onSubmit={handleFormSubmit}>
                      ...
                      <button type="submit" className="btn" style={{ backgroundColor: '#8A2BE2', color: '#FFFFFF' }}>Save Changes</button>
            ...
            <button className="btn" style={{ backgroundColor: '#8A2BE2', color: '#FFFFFF' }}onClick={(e) => handleLogout(e)}>
